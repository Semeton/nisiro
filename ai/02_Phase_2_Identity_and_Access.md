...
-   [ ] **Constraint**: Ensure these tables exist in the _Tenant_ schema, not just central (unless System Users are central). _Decision_: Per spec, strict isolation. Business users are in Tenant schema.
