...
- **Database**: MySQL 8.0+ (Single Database, Row-level isolation via `tenant_id`).
- **Testing**: Pest PHP.
...
- **No Cross-Tenant Access**: Tenants are isolated via global scopes. Never query data across tenants without explicit authorization.
